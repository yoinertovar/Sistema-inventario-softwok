  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl border border-slate-100 shadow-2xl p-8 text-center flex flex-col items-center">
        <div className="p-4 bg-rose-50 text-rose-600 rounded-full mb-5">
        ...
        <p className="mt-3 text-sm text-slate-500 leading-relaxed">
          Tu cuenta de usuario no cuenta con los permisos necesarios para visualizar esta sección. Ponte en contacto con el administrador para solicitar acceso.
        </p>
